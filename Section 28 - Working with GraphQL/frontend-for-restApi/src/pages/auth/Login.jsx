...
//     setLoginForm((prevLoginForm) => {
//       const currentField = prevLoginForm[input] || { validators: [] };

//       let isValid = true;
//       for (const validator of currentField.validators) {
//         isValid = isValid && validator(stringValue);
//       }
...
const Login = ({ onLogin, loading }) => {
  ...
  const inputChangeHandler = useCallback((input, value) => {
    setLoginForm((prevLoginForm) => {
      const updatedField = {
        ...prevLoginForm[input],
        value,
        valid: prevLoginForm[input].validators.every((validator) =>
          validator(value)
        ),
      };

      const updatedForm = { ...prevLoginForm, [input]: updatedField };
  ...
  const inputBlurHandler = useCallback((input) => {
    setLoginForm((prevLoginForm) => ({
      ...prevLoginForm,
      [input]: { ...prevLoginForm[input], touched: true },
    }));
  }, []);
